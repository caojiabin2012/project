...
?>
    ...
    <script type="text/javascript" src="/public/plug/CodeMirror/5.21.0/mode/xml/xml.js"></script>
    <script type="text/javascript" src="/public/plug/CodeMirror/5.21.0/mode/css/css.js"></script>
    <script type="text/javascript" src="/public/plug/CodeMirror/5.21.0/mode/javascript/javascript.js"></script>
    <script type="text/javascript" src="/public/plug/CodeMirror/5.21.0/mode/php/php.js"></script>
    <script type="text/javascript" src="/public/plug/CodeMirror/5.21.0/mode/ruby/ruby.js"></script>
    <script type="text/javascript" src="/public/plug/CodeMirror/5.21.0/mode/sql/sql.js"></script>
    <script type="text/javascript" src="/public/plug/CodeMirror/5.21.0/mode/http/http.js"></script>


    <div class="container">
        <?php include(dirname(dirname(__DIR__)).'/navbar.php');?>
        <?php $active = 'html'; include(__DIR__.'/tablist.php');?>
        ...
        <div class="tab-content">
            ...
            <div class="alert alert-success alert-dismissible fade in" role="alert">
                ...
                <strong>在线HTML在线格式化高亮格式化!</strong> 请将HTML在线格式化代码复制至下面的编辑框中即可， 按F11进入全屏，按ESC退出全屏。
            </div>

            <div role="tabpanel" class="tab-pane active">
	<textarea id="code" name="code" placeholder="请输入要转换的HTML在线格式化代码">&lt;html style="color: green"&gt;
  &lt;!-- this is a comment --&gt;
  &lt;head&gt;
